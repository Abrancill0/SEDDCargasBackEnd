...
{
    public class TipoCompetenciaController : ApiController
    {
        ...
        public JObject Post(ParametorsEntrada Datos)
        {
            ...
            try
            {
                ...
                for (int i = 1; i < ArregloFinal.Length; i++)
                {
                    ...
                    string DescripcionCompetencia = Convert.ToString(Valores[1]);
                    string Idioma = Convert.ToString(Valores[2]);
                   
                    SqlCommand comando2 = new SqlCommand("Cargas.AltaTipoCompetencias");
